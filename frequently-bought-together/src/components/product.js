...
const Product = props => {
    const { id, title, image, price, rating,cartedItem,checked,description,defaultItem } = props;
    ...
    <Link to="/productview" state={props}>
      ...
      <div className="prod-description-container">
        ...
        <div className="rate-details">
            ...
            {id !== 2 ? <ColorSelect id={id} color={colors}/>:<ProductCounter data={props} isChecked={isChecked}/>}
        </div>
      </div>
    </div>
  );
